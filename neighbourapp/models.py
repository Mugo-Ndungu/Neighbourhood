...
class Neighbour(models.Model):
    ...
    image = models.ImageField(upload_to='Neighbour/')
    occupants = models.IntegerField(default=0)
    police = models.IntegerField(default='999')
    ...
    def search_neighbour(cls, search_term):
        neighbour = cls.objects.filter(
            neighbourhood_name__icontains=search_term)
        return neighbour
...
class Profile(models.Model):
    ...
    bio = models.CharField(
        max_length=150, default='Hi, I am using Nyumba Kumi')
...
class Post(models.Model):
    ...
    neighbourhood = models.ForeignKey(
        Neighbour, related_name='post', null=True)
