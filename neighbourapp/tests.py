...
class NeighbourTestClass(TestCase):
    ...
    def test_delete(self):
        estate = Neighbour.objects.filter(id=1)
        estate.delete()
        estates = Neighbour.objects.all()
        self.assertTrue(len(estates) == 0)

    def test_get_estate_by_id(self):
        self.Nei.save()
        estates = Neighbour.objects.get(id=1)
        self.assertTrue(estates.name, 'kenha')
...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.new_user = User(username='aa', first_name='a',
                             last_name='a', email='a@gmail.com')
        self.new_user.save()
